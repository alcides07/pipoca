...
def upgrade():
    ...
    op.create_table('validador_testes',
                    ...
                    sa.ForeignKeyConstraint(
                        ['validador_id'], ['validadores.id'], ),
                    sa.PrimaryKeyConstraint('id')
                    )
    op.create_index(op.f('ix_validador_testes_id'),
                    'validador_testes', ['id'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_validador_testes_id'),
                  table_name='validador_testes')
