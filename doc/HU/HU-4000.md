...
- ### 2.1.2 Upload de Arquivo(s):
  ...
  - **ENTÃO** o sistema salva o(s) arquivo(s) e exibe a mensagem "Sucesso. Arquivo(s) cadastrado(s)!"
...
### 4.1. Arquivos de Recursos

- ### 4.1.1 Campos do Formulário de Cadastro Manual:
...
- ### 4.1.2 Campos do Formulário de Upload de Arquivo(s):
...
- ### 4.2.1 Campos do Formulário de Cadastro Manual:
...
- ### 4.2.2 Campos do Formulário de Upload de Arquivo(s):
...
### 4.2. Arquivos de Anexo

- ### 4.3.1 Campos do Formulário de Cadastro Manual:
...
- ### 4.3.2 Campos do Formulário de Upload de Arquivo(s):
